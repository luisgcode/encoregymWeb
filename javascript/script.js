...
const tabDay = document.querySelectorAll(
  ".schedule__inner-top .crowd__tab-day"
);
...
const headersignin = document.querySelectorAll(
  ".header__nav-log .header__link--login"
);
